...
class ImageViewer {
    ...
    private _$actionBar:HTMLElement;
    private _$actionBarTitle:HTMLElement;
    private _$downloadBar: HTMLElement;
    private _$downloadIcon: HTMLElement;
    private _$touchStartTarget: EventTarget;
    private _$backArrow:SVGSVGElement;
    ...
    private _downloadIconText:string;
    private _openMode: 'newPage'|'overlay' = 'newPage';
    ...
    private _startDiagonalLength:number;
    set downloadIconText(text:string){
    ...
    private _downloadFn:()=>void = function () {
        console.log('download button fired');
    };
    set downloadFn(fn:()=>void){
        this._downloadFn = fn;
    }
    private _singleTouch:()=>void;
    set singleTouch(fn:()=>void){
        this._singleTouch = fn;
    }
    private _longTouch:()=>void = function () {
        console.log('long touch fired');
    };
    private _longTouchTimer:number;
    private _longTouchDuration:number = 1000;
    private _longTouchStart:boolean = false;
    private _longTouchTrackX:number;
    private _longTouchTrackY:number;
    set longTouch(fn:()=>void){
        this._longTouch = fn;
    }

    static getDiagonalLength(xl:number,yl:number){
    ...
    public touchMove(event:TouchEvent){
        ...
        if(event.touches.length === 1){
            ...
            if(event.type === 'touchmove'){
                ...
                let ew = ImageViewer.getDiagonalLength(touch1.clientX - touch2.clientX, touch1.clientY - touch2.clientY) - self._startDiagonalLength;
